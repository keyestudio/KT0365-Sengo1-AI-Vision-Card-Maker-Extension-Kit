...
label = 1: the car moves forward; label = 2: the car turns left; label = 3: the car turns right; label = 4: the car moves backward; label = 5 or no card is detected: the car stops.
